...
const mnemonic_ganache_gui = "tomorrow draft giggle design purchase daring goddess cute inquiry giant thumb journey";
...
module.exports = {
  ...
  networks: {
    ...
    ganache_gui_localhost_HDW: {
      // must be a thunk, otherwise truffle commands may hang in CI
      provider: () => new HDWalletProvider(mnemonic_ganache_gui, 'http://localhost:7545'),
      network_id: '5777',
      // shareNonce:false,
    ...
    truffle_localhost_HDW: {
      // must be a thunk, otherwise truffle commands may hang in CI
      provider: () => new HDWalletProvider(mnemonic_truffle, 'http://localhost:9545'),
      network_id: '*',
      // shareNonce:false,
      // websockets: true,	// enabled to use the confirmations listener or to hear Events using .on or .once
      // production: true,	// Treats this network as if it was a public net. (default: false)
